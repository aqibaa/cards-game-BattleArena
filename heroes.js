...
const _heroData = [
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Clan Akkaba, employer of Apocalypse's Horsemen, Dark Riders, former employer of the Alliance of Evil, 198",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Aquaman Family; formerly Black Lantern Corps, Sentinels of Magic, Teen Titans",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Omega Flight, formerly Commission on Superhuman Activities , Freedom Force , Avengers , Secret Defenders , Force Works , Queen?s Vengeance , West Coast Avengers, Secret Avengers (Civil War)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Men (founding member); X-Force; Mutantes Sans Fronti?res; Hellfire Club; formerly X-Club (founding member); Death's champions; Secret Defenders; X-Factor\/X-Terminators (founding member); Horsemen of Apocalypse; Defenders; Champions of Los Angeles (fou",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Order of St. Dumas; formerly Gotham City Police Department; Three Ghosts of Batman",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Titans East, League of Assassins, Batman Family, Justice League Elite, Young Justice",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Was once in a merged form with the Molecule Man but is no longer merged with him.",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Superman Revenge Squad; Bizarros of Bizarro World; former associate of the Secret Society of Super-Villains; Joker League of Anarchy; former partner of Batzarro",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Birds of Prey; formerly Justice League of America, Justice Society of America, Justice League Task Force, Justice League International, Team Arrow",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "MI-13; formerly Avengers, Masters of Evil (as a mole), Excalibur, Heroes for Hire, Ultraforce (in the Ultraverse), Defenders, Knights of Wundagore, Queen's Vengeance, King Richard's Army",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Utopians, X-Men (New Charles Xavier School member), X-Force, X-Men, Nextwave, The Underground, Genoshan Mutates, New Mutants, X-Terminators (founding member), X-Factor (trainee), Fallen Angels, Beyonder (associate)",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Dark Avengers, Thunderbolts, employee of Kingpin, Purple Man, Eric Slaughter, Mysterio; formerly US Army",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Force, (former) X-Men, Clan Askani, Clan Chosen, Six Pack (formerly Wild Pack II)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Justice League, Extreme Justice, Super Buddies, Living Assault Weapons, Monarch's Army, United States Air Force",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Justice League, Rogues; formerly Secret Society of Super-Villains, Injustice League",
    ...
    },
    {
        ...
        "biography": {
            ...
            "place-of-birth": "-",
            "first-appearance": "Current incarnation: (As Freddy Freeman) The Power of Shazam #3 (May, 1995)",
            "publisher": "DC Comics",
            "alignment": "good"
        },
        "appearance": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "formerly Loners, New Warriors, Avengers West Coast (reservist), Secret Defenders (founder)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Incredible Family (genetic member), National Supers Agency (ties), Edna Mode (receives costumes and gadgets from her), Frozone (long-time friend), Mirage (ally)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Excalibur, X-Babies (guardian), Mojoverse Rebellion, X-Men, Cat's Laughing, Gladiators",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "White Lantern Corps, formerly Sentinels of Magic, Seven Soldiers of Victory, Justice League of Apostles",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly All-Star Squadron, Justice Society of America, Justice League International, Black Lantern Corps",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Thunderbolts Army; Former leader of the Sinister Six and the Masters of Evil V; Former partner of Green Goblin",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Guardians of the Galaxy; formerly Infinity Watch, Secret Defenders, United Front, Selects of the Phalanx",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Sinister Six formerly Emissaries of Evil, Frightful Four and Sinister Twelve",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Affiliation \"Fin Fang Four,\" former ally of the Mandarin, pawn of Doctor Vault, member of starship crew",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Firestorm Matrix, Justice League,formerly Black Lantern Corps, Power Company, White Lantern Corps",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Flash Family, Teen Titans, Legion of Super-Heroes; formerly Young Justice",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Galactic Council, Annihilators; formerly Imperial Guard; possibly Heralds of Galactus",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "H.A.M.M.E.R., leader of the Dark Avengers; formerly Thunderbolts, The Cabal; Former leader of the Sinister Twelve, partner of Mendell Stromm, Crime Master, employer of the Enforcers, Hellfire Club",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Green Lantern Corps, Justice League of America, Justice League Europe, frequently teamed with the second Flash and the original Green Arrow",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Uncanny Avengers; formerly X-Men, Starjammers, X-Factor Investigations, Six , Brotherhood, X-Factor, Dark Descendants, Genoshan Magistrates, Defenders for a Day",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Alaskan-based Initiative agent, Lady Liberators, Avengers, Defenders, Legion of the Unliving",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly God Squad, Council of Godheads, Olympia Corp., Mighty Avengers, Renegades, Secret Avengers, Avengers, Champions of Los Angeles, Defenders, Heroes for Hire, Damage Control, Olympian Gods, Argonauts, Defenders for a Day",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Flash Family, Teen Titans, formerly Legion of Super-Heroes, Young Justice",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "New Avengers, Heroes for Hire, Inc., Secret Defenders, Defenders, Misty Knight, Luke Cage",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Worthy, Thunderbolts, X-Men, Excalibur, Black Tom Cassidy (partner), Exemplars, Brotherhood of Evil Mutants, New World Order, Exiles, U.S. Army",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Former member of the Masters of Evil, Fearsome Foursome, and Frightful Four; Former ally of Solarr, Molecule Man, and Doctor Doom",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Green Lantern Corps, New Guardians, formerly Challengers From Beyond, Sinestro Corps, Justice League of America, Blue Lantern Corps, Titans",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Slaughter Lords (leader); formerly Galactic Council, ruler of the Spartoi Empire",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Marauders (founder), Nasty Boys (founder); formerly Weapon X, Third Reich",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "World Counterterrorism Agency; formerly Secret Avengers, New Avengers, West Coast Avengers, Avengers, Great Lakes Avengers, S.H.I.E.L.D.; partner of Hawkeye; associate of Dr. Wilma Calvin",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Cabal (founder), Invaders, Atlantis; formerly Illuminati, X-Men, Extinction Team, Phoenix Five, Defenders, Osborn's X-Men, Osborn's Cabal, Avengers, All-Winners Squad, Titans Three, Fantastic Four, Oracle Inc., Order, Deep Six (founder and leader); ally o",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Secret Avengers, SHIELD (both incarnations); formerly Team Valkyrie, C.I.A., liaison to MI-5, O.S.S., Howling Commandos, U.S. Army",
    ...
    },
    {
        ...
        "biography": {
            ...
            "place-of-birth": "Gotham City",
            "first-appearance": "as Dick Grayson and Robin) Detective Comics #38, (as Nightwing) Tales of the Teen Titans #44, (as Batman) Batman #512",
            "publisher": "Batman II",
            "alignment": "good"
        },
        "appearance": {
        ...
        "connections": {
            "group-affiliation": "Batman Family and the JLA; formerly the Teen Titans, the New Titans, the Titans and the Outsiders",
            "relatives": "John Grayson (father, deceased), Mary Grayson (mother, deceased), Bruce Wayne \/ Batman (adoptive father), Damian Wayne \/ Robin (foster brother), Jason Todd \/ Red Hood (adoptive brother), Tim Drake \/ Red Robin (adoptive brother), Cassandra Cain \/ Batgirl IV (adoptive sister)"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Nova Corps formely United Front (Leader), New Warriors, Champions of Xandar, Secret Defenders, Defender for a day",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Birds of Prey, Batman Family, Seven Soldiers of Victory, Suicide Squad, Justice League",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Thunderbolts (as Blackheath), Crime Wave, Defenders (Villains) , New Enforcers, former associate of the Maggia under Count Nefaria, ally of Wizard.",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "The FBI; formerly the Justice League of America; the All-Star Squadron and the Freedom Fighters",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Injustice Gang, Suicide Squad, Harley Quinn, Secret Society of Super Villains, Joker League of Anarchy",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Factor (Serval Industries); formerly X-Factor Investigations, Starjammers, X-Men, Horsemen of Apocalypse, Genoshan Cabinet, X-Factor (Government), The Twelve, Acolytes, Muir Island X-Men, Defenders for a Day, Marauders (possessed by Malice)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Justice Society of America, Justice League Europe, Infinity, Inc., Sovereign Seven",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly X-Men (founder; formerly teacher & leader), Illuminati, Genoshan Excalibur, Brotherhood of Evil Mutants (leader), Cadre K, Generation X (founder), Starjammers, The Twelve, New Mutants (founder, teacher & leader), United States Army, X-Corporation",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Secret Society of Super-Villains, Black Lantern Corps, White Lantern Corps",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Avengers, unofficial member of the Royal Family of the Inhumans, (former) Brotherhood of Evil Mutants I, X-Factor II",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Freedom Fighters, formerly Justice League of America, Justice League Task Force, Young Justice, JSA Reserves, Forgotten Heroes, Justice League Internationa",
    ...
    },
    {
        ...
        "biography": {
            ...
            "place-of-birth": "-",
            "first-appearance": "(as Speedy) More Fun Comics # 73(Nov. 1941); (as Arsenal) The New Titans # 99 (July 1993); (as Red Arrow) Justice League of America Vol. 2 # 7 (May 2007)",
            "publisher": "DC Comics",
            "alignment": "good"
        },
        "appearance": {
        ...
        "connections": {
            "group-affiliation": "Titans, Justice League of America, formerly Outsiders, Teen Titans, Checkmate, Central Bureau of Investigations",
    ...
    },
    {
        ...
        "biography": {
            ...
            "place-of-birth": "-",
            "first-appearance": "As Red Tornado: Justice League of America #64, As Ulthoon: Mystery in Space #61",
            "publisher": "DC Comics",
            "alignment": "good"
        },
        "appearance": {
        ...
        "connections": {
            "group-affiliation": "Justice League of America, formerly Parliament of Vapors, T.O. Morrow, Justice Society of America, Young Justice, Primal Force, Leymen, Donna Troy",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly leader of the Time Masters; former member of the Forgotten Heroes; former member of the Linear Men, Booster Gold International (BGI)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Batman Family, Batman Inc., Wayne Enterprises; formerly Teen Titans, League of Assassins",
    ...
    },
    {
        ...
        "biography": {
            ...
            "place-of-birth": "Place of birth unknown",
            "first-appearance": "Amazing Spider-Man # 149 (as Spider-Clone); Web of Spider-Man # 117 (as Ben Reilly)",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Avengers (Osborn's team); formerly Thunderbolts, Masters of Evil, \"Spider-Man Revenge League\"; Sinister Twelve; formerly partners with Mister Hyde and Delilah",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Horsemen of Death, Osborn's Avengers, Mighty Avengers, New Avengers, partner of Scout",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Men (New Charles Xavier School member), X-Men (Past) (tutor); formerly X-Men, Murder Circus (brainwashed), Lights (liaison), Paladins Squad, S.H.I.E.L.D., Gladiators, Excalibur (founding member), New Mutants, Knights of Wundagore",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "MI-5, MI-6, \"Marvel Knights\", Heroes For Hire, Freelance Restorations, Si-Fan, Secret Avengers",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Goodman, Lieber, Kurtzberg, & Holliway; formerly Avengers, Fantastic Four, Heroes for Hire",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Frightful Four; formerly Fantastic Four, Unlimited Class Wrestling Federation, Thunderiders",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Masters of Evil, Sinister Syndicate, Sinister Seven, Sinister Twelve",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Black Cat's Gang, Fact Channel News; formerly Spider-Army, partner of Spider-Man, Ezekiel Sims",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Sinestro Corps, formerly Green Lantern Corps, Secret Society, Injustice League",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Eighth Circle of Hell; formerly (as Al Simmons) CIA (U.S. Security Service), U.S. Secret Service, U.S. Marine Corps",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly R.E.B.E.L.S., Justice League of America, Teen Titans, Outsiders",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Men (Jean Grey School member, leader); formerly X-Force (Strike Team); Murder Circus (brainwashed), Extinction Team, Avengers[3], Fantastic Four, X.S.E., X-Treme X-Men, Tokyo Arena, The Twelve, Seven Brides of Set, Hellfire Club (Inner Circle), Morlocks",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Avengers; formerly X-Men, New Mutants, Young X-Men, X-Corporation (Los Angeles branch), MLF, X-Force, Fallen Angels, Hellfire Club, Bratpack",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly Justice League of America, Supermen of America, Justice League of Amazons, Kent Family, Superman Family, Kryptonian Science Guild, Teen Titans, Legion of Super-Heroes, Outsiders",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Fantastic Four formerly Avengers West Coast, Unlimited Class Wrestling Federation, Thunderiders",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Villains for Hire, Lethal Legion, Dr. Dorcas; Masters of Evil; Namor's Deep Six; Attuma's Deep Six; Offenders",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "198; (formerly) Brotherhood of Evil Mutants, Misfits; (formerly) associate of Gideon, Emma Frost",
            "relatives": "-"
        },
        "image": {
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Formerly; temporary partner of Agent Venom, Savage Six, Sinister Six, Revengers, former partner of Vengeance, Spider-Man, Scarlet Spider. Volunteer at F.E.A.S.T.",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Inhuman Royal Family, Universal Inhumans, Royal Guard, New Inhuman Elite; formerly Shi'ar Army Elite Corps & Imperial Guard[citation needed], Namor's Deep Six",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Initiative; formerly: Sentinel Squad O*N*E, Office of National Emergency (O*N*E), Crew, Secret Defenders, Worldwatch, Stark Enterprises, Force Works, West Coast Avengers, U.S. Marine Corps",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "X-Men (Team Cyclops), Security Recon; formerly X-Force (Strike Team), X-Corporation, X-Force, New Mutants, Hellions",
    ...
    },
    {
        ...
        "connections": {
            "group-affiliation": "Misty Kilgore, Seven Soldiers of Victory, Justice League, Sentinels of Magic",
